...
class integrated_dispatch_feasible:
    def __init__(self):
        self.data = expando()
    ...
    def _load_data(self):
        ...
        self.data.mf_pipe = mf_pipe
        self.data.mf_HES = mf_HES
        self.data.mf_HS = mf_HS
        self.data.mf_slack = mf_slack
        self.data.tau = time_delay
        self.data.u = u 
        self.data.v = v
...
#        self.constraints.new_const = m.addConstr(
#                        self.variables.Q['HP1', 't04'],
#                        gb.GRB.GREATER_EQUAL,
#                        0)                 
                                               
#%% SOLVE                       

dispatch_feasible = integrated_dispatch_feasible()
dispatch_feasible.model.params.OutputFlag = 1
#tstart = datetime.now()
#tstart = tt.time()
dispatch_feasible.optimize()
#tend = tt.time()
#tend = datetime.now()
